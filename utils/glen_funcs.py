...
def get_interpolation_residual(data, verbose=False):
    """
    Calculate the residual between the interpolated data and the original data.  Interpolated data is a line between the two end values.
    """
...
def plot_uncertainty_comparison(residuals, uncertainties):
    ...
    plt.show()
    return fail_points, [mean_error, current_rmse]
